...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-start gap-1 overflow-x-auto rounded-xl border border-border/80 bg-surface/40 p-1 text-muted-foreground scrollbar-none",
      className,
    )}
    {...props}
  />
