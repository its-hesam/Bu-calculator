        ...
        <div className="space-y-5 animate-slide-up">
          ...
          <TemplateCards
            ...
            params={{
              ...
              mmr: `${mmr}%`,
              stable,
              margin: fmt(resultBlock.margin, 6),
              mm: fmt(resultBlock.maintenanceMargin, 6),
              buffer: fmt(resultBlock.margin - resultBlock.maintenanceMargin, 6),
              diff: fmt(resultBlock.diff, 6),
              sign: sideType === "long" ? "−" : "+",
        ...
        <div className="space-y-5 animate-slide-up">
          ...
          <TemplateCards
            ...
            params={{
              ...
              margin: fmt(resultBlock.margin, 6),
              mm: fmt(resultBlock.maintenanceMargin, 6),
              pv: resultBlock.positionValue.toFixed(6),
              bf: resultBlock.bankruptcyFee.toFixed(6),
              adj: resultBlock.adjustment.toFixed(6),
              sign: sideType === "long" ? "+" : "-",
              belowAbove: sideType === "long" ? "below" : "above",
              liq: resultBlock.liquidationPrice.toFixed(6),
              move: `${resultBlock.movePct}%`,
